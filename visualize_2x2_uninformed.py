...
from RubikState.rubik_solver_2x2 import bfs_search_2x2, dfs_search_2x2, ucs_search_2x2, ids_search_2x2
...
def run_algorithms(scrambled_states, depths, time_limit=30):
    """Run uninformed search algorithms on scrambled states"""
    algorithms = {
        "BFS": bfs_search_2x2,
        "DFS": dfs_search_2x2,
        "UCS": ucs_search_2x2,
...
def create_visualizations(results, depths):
    """Create visualization charts for uninformed search results"""
    ...
    # Save the figure
    plt.savefig('visualizations/2x2_uninformed_search.png', dpi=300)
    print(f"Visualization saved to 'visualizations/2x2_uninformed_search.png'")
    
    return plt

if __name__ == "__main__":
    print("Rubik's Cube 2x2 - Uninformed Search Algorithms Visualization")
    print("=============================================================")
