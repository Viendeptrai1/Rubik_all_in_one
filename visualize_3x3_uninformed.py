...
from RubikState.rubik_solver_3x3 import bfs_search_3x3, dfs_search_3x3, ucs_search_3x3, ids_search_3x3
...
def run_algorithms(scrambled_states, depths, time_limit=10):
...
def create_visualizations(results, depths):
    ...
    # Save the figure
    plt.savefig('visualizations/3x3_uninformed_search.png', dpi=300)
    print(f"Visualization saved to 'visualizations/3x3_uninformed_search.png'")
    
    return plt

if __name__ == "__main__":
    print("Rubik's Cube 3x3 - Uninformed Search Algorithms Visualization")
    print("=============================================================")
