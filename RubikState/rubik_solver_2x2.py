...
def simple_hill_climbing_search_2x2(start_state, goal_state=None, moves_dict=None, time_limit=30, max_iterations=1000, return_stats=False):
    """
    Simple Hill Climbing algorithm for 2x2 Rubik's cube
