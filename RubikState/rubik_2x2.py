...
MOVES_2x2 = {
    ...
    'R': {
        ...
        'co': (2, 0, 0, 1, 1, 0, 0, 2), # Hướng: URF(+2), URB(+1), DRB(+2), DRF(+1)
    },
    # === Phép xoay mặt F (Front - trước) 90 độ CW ===
    'F': {
        'cp': (1, 5, 2, 3, 0, 4, 6, 7), # Góc: 0->1, 1->5, 5->4, 4->0
        'co': (1, 2, 0, 0, 2, 1, 0, 0), # Hướng: URF(+1), ULF(+2), DLF(+1), DRF(+2)
    },
    ...
    'L': {
        'cp': (0, 2, 6, 3, 4, 1, 5, 7), # Góc: 1->2, 2->6, 6->5, 5->1
        'co': (0, 1, 2, 0, 0, 2, 1, 0), # Hướng: ULF(+1), ULB(+2), DLB(+1), DLF(+2)
    },
    # === Phép xoay mặt B (Back - sau) 90 độ CW ===
    'B': {
        'cp': (0, 1, 3, 7, 4, 5, 2, 6), # Góc: 2->3, 3->7, 7->6, 6->2
        'co': (0, 0, 1, 2, 0, 0, 2, 1), # Hướng: ULB(+1), URB(+2), DRB(+1), DLB(+2)
    },
    ...
    "R'": {
        ...
        'co': (2, 0, 0, 1, 1, 0, 0, 2), # Hướng ngược R (Đã sửa)
    },
    "F'": {
        'cp': (4, 0, 2, 3, 5, 1, 6, 7), # Nghịch đảo cp của F
        'co': (1, 2, 0, 0, 2, 1, 0, 0), # Hướng ngược F (Đã sửa)
    },
    "D'": {
    ...
    "L'": {
        ...
        'co': (0, 1, 2, 0, 0, 2, 1, 0), # Hướng ngược L (Đã sửa)
    },
    "B'": {
        'cp': (0, 1, 6, 2, 4, 5, 7, 3), # Nghịch đảo cp của B
        'co': (0, 0, 1, 2, 0, 0, 2, 1), # Hướng ngược B (Đã sửa)
    }
}
